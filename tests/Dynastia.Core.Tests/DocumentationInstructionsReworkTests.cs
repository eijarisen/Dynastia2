...
public sealed class DocumentationInstructionsReworkTests
{
    ...
    {
        var instructions = Read("src", "Dynastia.App", "Views", "InstructionsWindow.axaml");
    ...
    {
        var instructions = Read("src", "Dynastia.App", "Views", "InstructionsWindow.axaml");
        var codeBehind = Read("src", "Dynastia.App", "Views", "InstructionsWindow.axaml.cs");
    ...
    public void GameDesignDocumentationHasAllPlannedDomainFilesAndCurrentBaselineFacts()
    {
        ...
        {
            var path = Path.Combine(RepositoryRoot(), "docs", "GameDesign", file);
    ...
    public void ReadmeAndDevelopmentMapPointToDesignReferenceAndCurrentStartRange()
    {
        ...
        var map = Read("docs", "DevelopmentMap.md");
